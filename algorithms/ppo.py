    ...
    def update(self, rollouts):
        ...
        for _ in range(self.ppo_epoch):
            ...
            for sample in data_generator:
                obs_batch, recurrent_hidden_states_batch, actions_batch, value_preds_batch, return_batch, masks_batch, old_action_log_probs_batch, adv_targ, val_obs_batch, val_recurrent_hidden_states_batch, val_masks_batch = sample
                ...
                if self.actor_critic.use_distribution_matching:
                    ...
                    _, _, _, val_z, val_mu, val_std = self.actor_critic.get_action_dist(val_obs_batch,
                                                                                        val_recurrent_hidden_states_batch,
                                                                                        val_masks_batch)
