...
def get_args(rest_args):
    ...
    parser.add_argument('--num_processes', type=int, default=74,
                        help='how many training CPU processes to use (default: 74.')
    ...
    parser.add_argument("--use_distribution_matching", type=boolean_argument, default=True,
    ...
    parser.add_argument("--percentage_levels_train", type=float, default=0.8,
                        help='Proportion of the train levels to use for train and the rest is used for validation. Range is [0,1]')
    parser.add_argument("--num_val_envs", type=int, default=10,
                        help='Number of environments from --num_processes to use for validation.')

    # hyperparameters
    parser.add_argument("--dist_matching_coeff", type=float, default=1e-4,
                        help='Coefficient in front distribution matching loss term.')
    parser.add_argument("--dist_matching_num_components", type=int, default=1,
